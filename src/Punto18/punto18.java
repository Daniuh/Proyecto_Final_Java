...
public class punto18 {
    public static void main(String[] args) {
        ...
        //Recorremos los arrays para contar cuantos entregados hay, también los devolvemos
        int entregados = 0;
        ...
        //Creamos dos objetos con la primera posición de cada array
        Serie serieMayor = listaSeries[0];
        Videojuego videojuegoMayor = listaVideojuegos[0];
        //Recorremos el array desde la posición 1 (no 0), comparando el mayor con las posiciones del array
